...
const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      year: "2026",
      description: "Standalone precision instrument for testing, scoring, and monitoring every layer of the CPNA system — from intent classification and therapy gating to retrieval quality and context safety.",
    ...
    },
    {
      ...
      year: "2026",
      description: "Two-sided AI-powered social commerce platform for African fashion creators entering global markets — combining live commerce, creator discovery, and AI-powered search relevance.",
    ...
    },
    {
      ...
      year: "2025–Present",
      description: "Prize-draw platform enabling Nigerians to win high-value homes through structured, transparent draw cycles — an alternative to mortgage debt and instalment loans.",
  ...
  caseStudies: [
    {
      ...
      keyInsights: [
        "Cognitive quality is not a property you check for. It is a property you maintain — and maintenance requires continuous monitoring across every output, at scale.",
        ...
        "Integration over replacement: CognArc owns cognitive impact scoring and integrates cleanly with Braintrust, Amplitude, and Figma — the decision that determines whether a product gets adopted or faces resistance."
      ],
    ...
    },
    {
      ...
      keyInsights: [
        ...
        "The admin dashboard was designed as a single source of truth for product and growth analytics — connecting creator management, inventory visibility, and live commerce performance in one operator surface."
      ],
  ...
  experience: [
    {
      ...
      period: "May 2026",
      type: "Contract",
      description: "Leading end-to-end product delivery of a three-platform Nigerian loan management system: borrower mobile app, collector mobile & web app, and admin dashboard — from zero to launch.",
      highlights: [
    ...
    },
    {
      ...
      period: "2025 – Present",
      type: "Full-time",
      description: "Prize-draw platform enabling Nigerians to win high-value homes through structured, transparent draw cycles — an alternative to mortgage debt.",
      highlights: [
  ...
  blogPosts: [
    ...
    },
    {
      ...
      url: null,
      filePath: "resources/blog/How%20to%20Use%20NotebookLM%20for%20In-Depth%20Market%20Research%20(.pdf",
      videoFile: null,
      videoUrl: null
    },
    {
